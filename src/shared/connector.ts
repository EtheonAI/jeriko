...
export const CONNECTOR_DEFS: ConnectorDef[] = [
  ...
  },
  {
    name: "sendgrid",
    label: "SendGrid",
    description: "Email sending, contacts, templates, stats",
  ...
  },
  {
    name: "square",
    label: "Square",
    description: "Payments, orders, customers, catalog, inventory",
    required: ["SQUARE_ACCESS_TOKEN"],
    optional: ["SQUARE_REFRESH_TOKEN", "SQUARE_SANDBOX"],
    oauth: { clientIdVar: "SQUARE_OAUTH_CLIENT_ID", clientSecretVar: "SQUARE_OAUTH_CLIENT_SECRET" },
  },
  {
    name: "gitlab",
    label: "GitLab",
    ...
    optional: ["GITLAB_REFRESH_TOKEN"],
    oauth: { clientIdVar: "GITLAB_OAUTH_CLIENT_ID", clientSecretVar: "GITLAB_OAUTH_CLIENT_SECRET" },
    limitParam: "per_page",
  },
  {
    name: "cloudflare",
  ...
  },
  {
    ...
    required: ["NOTION_ACCESS_TOKEN"],
    optional: [],
    oauth: { clientIdVar: "NOTION_OAUTH_CLIENT_ID", clientSecretVar: "NOTION_OAUTH_CLIENT_SECRET" },
  },
  {
    name: "linear",
    label: "Linear",
    description: "Issues, projects, teams, cycles, labels",
    required: ["LINEAR_ACCESS_TOKEN"],
    optional: [],
    oauth: { clientIdVar: "LINEAR_OAUTH_CLIENT_ID", clientSecretVar: "LINEAR_OAUTH_CLIENT_SECRET" },
  },
  {
    name: "jira",
    label: "Jira",
    description: "Issues, projects, boards, sprints",
    required: ["JIRA_ACCESS_TOKEN"],
    optional: ["JIRA_CLOUD_ID", "JIRA_REFRESH_TOKEN"],
    oauth: { clientIdVar: "JIRA_OAUTH_CLIENT_ID", clientSecretVar: "JIRA_OAUTH_CLIENT_SECRET" },
  },
  {
    name: "airtable",
    label: "Airtable",
    description: "Bases, tables, records, fields",
    required: ["AIRTABLE_ACCESS_TOKEN"],
    optional: ["AIRTABLE_REFRESH_TOKEN"],
    oauth: { clientIdVar: "AIRTABLE_OAUTH_CLIENT_ID", clientSecretVar: "AIRTABLE_OAUTH_CLIENT_SECRET" },
  },
  {
    name: "asana",
    label: "Asana",
    description: "Tasks, projects, sections, workspaces",
    required: ["ASANA_ACCESS_TOKEN"],
    optional: ["ASANA_REFRESH_TOKEN"],
    oauth: { clientIdVar: "ASANA_OAUTH_CLIENT_ID", clientSecretVar: "ASANA_OAUTH_CLIENT_SECRET" },
  },
  {
    name: "mailchimp",
    label: "Mailchimp",
    description: "Lists, members, campaigns, templates",
    required: ["MAILCHIMP_ACCESS_TOKEN"],
    optional: ["MAILCHIMP_DC", "MAILCHIMP_REFRESH_TOKEN"],
    oauth: { clientIdVar: "MAILCHIMP_OAUTH_CLIENT_ID", clientSecretVar: "MAILCHIMP_OAUTH_CLIENT_SECRET" },
  },
  {
    name: "dropbox",
    label: "Dropbox",
